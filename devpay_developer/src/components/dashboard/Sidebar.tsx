...
import { developer, counts } from "@/lib/mock-data";
...
const navItems: NavItem[] = [
  { to: "/dashboard", label: "Overview", icon: Home, badge: 0, exact: true },
  { to: "/dashboard/jobs", label: "Browse Jobs", icon: Search, badge: 0 },
  { to: "/dashboard/jobs-for-you", label: "Jobs For You", icon: Sparkles, badge: 0 },
  { to: "/dashboard/proposals", label: "My Proposals", icon: FileText, badge: counts.pendingProposals },
  { to: "/dashboard/contracts", label: "Active Contracts", icon: Briefcase, badge: counts.activeContracts },
  { to: "/dashboard/wallet", label: "Wallet", icon: Wallet, badge: 0 },
  { to: "/dashboard/payment-methods", label: "Payment Methods", icon: CreditCard, badge: 0 },
  { to: "/dashboard/messages", label: "Messages", icon: MessageCircle, badge: counts.unreadMessages },
  { to: "/dashboard/profile", label: "My Profile", icon: User, badge: 0 },
  { to: "/dashboard/settings", label: "Settings", icon: Settings, badge: 0 },
];
