...
const QUICK_LINKS: { label: string; to: string; hint: string }[] = [
  { label: "Overview", to: "/client", hint: "Dashboard home" },
  { label: "Post a Job", to: "/client/post-job", hint: "Create a new posting" },
  { label: "Browse Developers", to: "/client/developers", hint: "Find talent" },
  { label: "My Jobs", to: "/client/jobs", hint: "Manage open posts" },
  { label: "Proposals", to: "/client/proposals", hint: "Review incoming bids" },
  { label: "Active Contracts", to: "/client/contracts", hint: "Track milestones" },
  { label: "Payments", to: "/client/payments", hint: "Escrow & transactions" },
  { label: "Messages", to: "/client/messages", hint: "Chat with developers" },
  { label: "Settings", to: "/client/settings", hint: "Account & billing" },
];
