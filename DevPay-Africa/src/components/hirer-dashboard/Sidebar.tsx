...
const items: NavItem[] = [
  ...
  { to: "/client/proposals", label: "Proposals", Icon: Inbox, badge: client.new_proposals_count },
  { to: "/client/contracts", label: "Active Contracts", Icon: FileCheck, badge: client.active_contracts_count },
  { to: "/client/payments", label: "Payments", Icon: CreditCard },
  { to: "/client/messages", label: "Messages", Icon: MessageCircle, badge: client.unread_messages },
    ...
    <TooltipProvider delayDuration={150}>
      ...
      >
        ...
        <div className={`flex items-center pt-6 ${collapsed ? "justify-center px-2 pb-5" : "justify-between px-4 pb-5"}`}>
          <Link to="/client" className="flex items-center gap-2 overflow-hidden">
